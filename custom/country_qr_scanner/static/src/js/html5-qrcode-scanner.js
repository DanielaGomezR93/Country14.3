...
var Html5QrcodeScanner = /*#__PURE__*/function () {
  ...
  _createClass(Html5QrcodeScanner, [{
    ...
    value: function __createSectionControlPanel() {
      ...
      requestPermissionButton.innerHTML = "Solicitar permisos de cámara";
      ...
      fileScanLabel.innerHTML = "&nbsp; Seleccionar Imagen";
    ...
    value: function __createSectionSwap() {
      var $this = this;
      var TEXT_IF_CAMERA_SCAN_SELECTED = "Escanear un archivo de imagen";
      var TEXT_IF_FILE_SCAN_SELECTED = "Escanee usando la cámara directamente";
      var section = document.getElementById(this.__getDashboardSectionId());
